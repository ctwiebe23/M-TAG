...
### Optional: Linux Bash Script

An extremely brief and simple bash script has been provided in
resources/bash_script that can be used to invoke the jar file as a terminal
command on linux with the added functionality of allowing you to pass '-' as
the filepath to act in the current directory.  Add this script to the PATH and
edit it so that the jar file is properly referenced; afterwards this program
can be invoked with

    m-tag <filepath or '-'> <options>
